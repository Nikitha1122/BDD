...
import com.cg.project.beans.GitHubLogin;
...
public class GitHubRegistration {
    ...
    public void setUpStepEnv()
   {
	...
	public void user_enters_valid_details() throws Throwable {
		...
		login.setUsername("Tinatinnu");
		login.setPassword("Tinnu@123");
		login.setEmail("tinnu123tina@gmail.com");
		login.clickSignIn();
	...
	public void user_enters_invalid_username() throws Throwable {
		...
		login.setPassword("kkllmmii123");
		login.setEmail("kklliimm@gmail.com");
		login.clickSignIn();
